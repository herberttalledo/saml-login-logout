...
//
        ...
        http
            ...
            http
                ...
                .antMatchers("/saml/**").permitAll()
                    .antMatchers(HttpMethod.GET, "/loginSOAP").permitAll()
  ...
  public SavedRequestAwareAuthenticationSuccessHandler successRedirectHandler() {
    ...
    successRedirectHandler.setDefaultTargetUrl( MAIN_URL );
  ...
  public SimpleUrlLogoutSuccessHandler successLogoutHandler() {
    ...
    simpleUrlLogoutSuccessHandler.setDefaultTargetUrl( MAIN_URL+"/saml/logout/" );
